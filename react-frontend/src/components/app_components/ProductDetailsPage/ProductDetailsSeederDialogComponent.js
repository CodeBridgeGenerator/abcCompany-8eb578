...
import seederData from "./productDetails.seeder.json";
...
const ProductDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProductDetailsSeederDialogComponent);
