...
import seederData from "./salesDetails.seeder.json";
...
const SalesDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SalesDetailsSeederDialogComponent);
