const { ProductDetails } = require("./productDetails.class");
const createModel = require("./productDetails.model");
const hooks = require("./productDetails.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productDetails", new ProductDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productDetails");

  // Get the schema of the collections 
  app.get("/productDetailsSchema", function (request, response) {
