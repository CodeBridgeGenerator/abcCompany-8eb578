const { SalesDetails } = require("./salesDetails.class");
const createModel = require("./salesDetails.model");
...
module.exports = function (app) {
  ...
  app.use("/salesDetails", new SalesDetails(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("salesDetails");

  // Get the schema of the collections 
  app.get("/salesDetailsSchema", function (request, response) {
